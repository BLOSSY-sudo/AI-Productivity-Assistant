...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7d91267e-d0f8-43b6-93ec-99b232da0092/id-preview-d33636d0--3b21fe74-1359-47e8-accd-3cbfe87b4930.lovable.app-1780572735064.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7d91267e-d0f8-43b6-93ec-99b232da0092/id-preview-d33636d0--3b21fe74-1359-47e8-accd-3cbfe87b4930.lovable.app-1780572735064.png" },
    ],
    links: [
      {
        rel: "stylesheet",
        ...
        <div className="flex min-h-screen w-full bg-background">
          ...
          <div className="flex flex-1 flex-col">
            <header className="flex h-14 items-center gap-3 border-b border-border bg-background/80 px-4 backdrop-blur">
              ...
              <span className="text-xs text-muted-foreground">AI Workplace Productivity</span>
            </header>
